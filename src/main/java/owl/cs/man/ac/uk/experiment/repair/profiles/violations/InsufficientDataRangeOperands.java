...
public class InsufficientDataRangeOperands extends OWLProfileViolation implements InsufficientOperandsViolation {
    private final OWLObject expression;

    public InsufficientDataRangeOperands(OWLOntology currentOntology, OWLAxiom node, OWLObject c) {
